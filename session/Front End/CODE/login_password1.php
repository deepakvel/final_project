...
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=2"><input type="button" value="Refresh"/></a><br />
<br />
';
...
$count++;
?>
<form action="log_process2.php?id=<?php echo $count; ?>" method="post" >
<?php
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=3"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process3.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=4"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process4.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=5"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process5.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=6"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process6.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=7"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process7.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=8"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process8.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password1.php?id=9"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process9.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
...
/*echo '<table border="0" cellpadding="0" cellspacing="0">';
echo '<tr><td>';*/
echo'<a href="login_password.php"><input type="button" value="Refresh"/></a><br />
<br />
';
echo '<table border="1" cellpadding="5" cellspacing="0" width="100px">';
echo '<tr>
...
$count++;
?>
<form action="log_process10.php?id=<?php echo $count; ?>" method="post" >
<?php
echo "<td><input type='submit' value='$count' /></td>";
            foreach($value as $key1=>&$val){
						 echo "<td><input type='hidden' name='$val'>$val</td>";
