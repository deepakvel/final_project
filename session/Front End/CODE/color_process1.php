...
if($id==1)
{
$sql=mysql_query("select * from color where uid='$uid' order by id asc")or die(mysql_error());
...
$color1=$color+1;
$sql1=mysql_query("insert into color_pass(color,color_values,uid)values('$color','$color1','$uid')");
if($sql1)
{
?>
...
echo "<a href='color.php'><input type='button' value='Back'></a><br /><br />
<br />
