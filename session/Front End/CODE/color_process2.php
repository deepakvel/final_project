...
{
$uid=$_SESSION['uid'];
$sql1=mysql_query("insert into color(uid,color)values('$uid','2')")or die(mysql_error());
if($sql1)
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=1");
}
}
...
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=2");
}
}
...
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=3");
}
}
...
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=4");
}
}
...
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=5");
}
}
...
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=6");
}
}
...
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process2_1.php?id=7");
}
}
