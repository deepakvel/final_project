...
echo "<br />";
	...
	<input type="submit" name="submit" value="Enter In Banking Process" />
</form>
<p>&nbsp;</p>
<?php
...
header("location:inner.php");
	...
	/*echo "<script>alert('You Have Entered Correct Password..<br />
Welcome To Our Banking Service')</script>";
	header("location:inner.php");*/
}
...
$sab=mysql_query("delete from color1 where uid='$uid'");
*/}
...
{
$uid=$_SESSION['uid'];
$sql1=mysql_query("insert into color1(uid,color)values('$uid','1')")or die(mysql_error());
if($sql1)
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color1_process1.php");
}
}
