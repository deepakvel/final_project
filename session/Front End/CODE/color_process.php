...
<a href="index.php">Home</a> | <a href="#">Portfolio</a> | <a href="#">Services</a> | <a href="#">Aboutus</a> | <a href="#">Contactus</a>
</div>
</div>
<div id="container">
<?php
...
echo "<td>THANK YOU <br />
YOUR GENERATED PASSWORD IS </td>";
...
{
$uid=$_SESSION['uid'];
$sql1=mysql_query("insert into color(uid,color)values('$uid','1')")or die(mysql_error());
if($sql1)
{
echo "<strong>CHOOSE COLOR</strong>";
header("location:color_process1.php");
}
}
